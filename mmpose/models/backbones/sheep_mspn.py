...
class ResNetTop(nn.Module):
    ...
    def __init__(self, norm_cfg=dict(type='BN'), in_channels=4, channels=64):
        # Protect mutable default arguments
        norm_cfg = cp.deepcopy(norm_cfg)
        super().__init__()
...
class SheepDepthMSPN(BaseBackbone):
    ...
    def __init__(self,
        ...
        self.top = ResNetTop(in_channels=self.in_channels, norm_cfg=norm_cfg)
